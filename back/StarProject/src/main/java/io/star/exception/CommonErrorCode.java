...
public enum CommonErrorCode implements ErrorCode {
	...
	MISSING_PARAMETER(HttpStatus.BAD_REQUEST, "메서드 매개 변수 유형에 필요한 요청 매개 변수 'id'가 없습니다. 확인 후 다시 시도해주세요."),
     
    //401
    INVALID_AUTH_TOKEN(HttpStatus.UNAUTHORIZED, "권한 정보가 없는 토큰입니다. 확인 후 다시 시도해주세요."),
