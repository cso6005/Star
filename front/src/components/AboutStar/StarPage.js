...
const StarPage = () => {
    ...
    const data2 = {
        '온도와 광도': <div>
                        ...
                        <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                            Harvard 스펙트럼 분류로 알려져 있으며 XNUMX 세기 후반 Harvard University에서 개발 된 이름에서 유래되었습니다.<br /> 이 분류는 천문학 자들이 가장 일반적으로 사용하는 것입니다. 그것은 온도와 그들이주는 광도에 따라 모든 별들을 나누는 역할을합니다.<br /> 별의 일곱 가지 주요 유형 인 O, B, A, F, G, K 및 M이 포함되며 색상은 파란색에서 빨간색까지 다양합니다.<br /><br />
                            Yerkes 스펙트럼 분류와 같은 다른 유형의 별 분류가 있습니다. 이 분류는 Harvard의 분류보다 늦었으며 별 분류와 관련하여 더 구체적인 모델이 있습니다.<br /> 이 분류는 별의 온도와 각 별의 표면 중력을 고려합니다. 여기에 다음과 같은 XNUMX 가지 유형의 별이 있습니다.<br /><br />
                            ● 0-극대 거성<br />● Ia-매우 빛나는 초거성<br />● Ib-낮은 광도의 초거성<br />● II-빛나는 거인<br />● III-거인<br />● IV-자이언트<br />● V-드워프 주 계열성<br />● VI-수 베나 나<br />● VII-백색 왜성<br />
                        </div>
                    </div>,
        '빛과 열': <div>
                    <h2 style={{fontWeight:"700", fontSize:"20px", paddingTop:"2%"}}>빛과 열에 따른 별 분류</h2>
                    <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                        ● 극대 거성 별: 우리 태양 질량의 100 배에 달하는 질량을 가진 것들입니다. 그들 중 일부는 이론적 인 질량 한계 인 120M에 접근하고있었습니다. 1M은 우리 태양과 동일한 질량입니다. 이 측정 수준은 별의 크기와 질량을 훨씬 더 잘 비교하는 데 사용됩니다.<br /><br />
                        ...
                        ● 백색 왜성 : 이 별들은 핵연료가 부족한 다른 별들의 잔재입니다. 이 유형의 별은 적색 왜성과 함께 전체 우주에서 가장 많습니다. 알려진 별의 97 %가이 단계를 거치는 것으로 추정됩니다. 일찍이 모든 별은 연료가 부족하여 결국 백색 왜성이됩니다.<br />
                    </div>
                </div>
    }
    ...
    const data = {
        ...
        '별의 종류': <div className="starKinds">
                        <div className="starKindsTop">
                            <button className="starKindsButton" onClick={()=>(
                                setCurrentState2('온도와 광도')
                            )}>온도와 광도</button>
                            <button className="starKindsButton" onClick={()=>(
                                setCurrentState2('빛과 열')
                            )}>빛과 열</button>
        ...
        '우리 은하': <div>
                            ...
                            <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                                ...
                                우리 은하의 지름은 약 10만 광년 정도이고 중심핵의 직경은 약 1만 광년, 두께는 1만 5천 광년 정도이다. 나선팔 부분, 항성이 집중된 영역의 두께는 1천~2천 광년 정도의 크기인 것으로 추산되며, 그 외의 가스층까지 포함하면 디스크의 두께는 1만 광년이 넘는다.<br /><br />
                                태양계가 은하의 구석진 변두리라는 인식이 있지만 이 정도 거리는 변두리는 아니고 중간 지점 쯤 된다. 이는 관측적 사실로도 알 수 있는데 은하수를 하늘에서 거의 1년 내내 볼 수 있다.<br /> 정말로 태양계가 은하의 변두리에 있었다면 1년 중 절반 정도는 은하수가 거의 보이지 않을 것이다.<br /> 
                                또한 은하수는 천구를 거의 정확하게 절반으로 나누며 지나가는데 이는 우리 태양계가 은하의 공전면에 아주 가깝게 붙어 있음을 알 수 있다.<br /><br />
                                지구에서 가장 가까운 은하이지만, 아이러니하게도 우리 은하의 전체 모습을 관측하는 것은 현재 기술로썬 불가능하다.<br /> 아직 인류의 활동 범위는 은하 원반은커녕 인공물이 태양계를 겨우 벗어나는 수준이기 때문에,<br />
                                우리 은하를 외부에서 촬영한 사진은 존재하지 않는다. 우리 은하의 지름이 대략 10만 광년이기 때문에, 이 광경을 찍으려면 못 해도 몇 만 광년 너머에서 찍어야 하고,<br /> 설사 여차저차해서 찍을 수 있더라도, 정보 전달 속도 역시 빛의 속도를 초과할 수는 없으므로, 사진 정보를 수신하는 데에만 몇 만 년이 걸릴 것이기 때문이다.<br />
                                과거에는 안드로메다 은하와 모습이 완전히 닮은 정상나선은하로 간주하여, 우리 은하는 중심의 은하핵과 4개의 나선팔을 가진 형태로 그려지는 경우가 많았다.<br />
                                그러나  2005년 스피처 우주 망원경으로 관측해, 우리 은하 중심부의 막대구조를 공식 확인했다. 그리고 우리 은하의 팔도 막대구조 끝에서 뻗어나온 2개의 나선팔이 있고,<br /> 여기서 가지치기한 2개의 나선팔이 더 있는 전형적인 막대나선은하(허블 분류에 따르면 SBbc형) 형태임이 드러났다.
                            </div>
                            <div style={{paddingTop:"2%"}}>
                                <button className="imgButton" onClick={()=>(
                            setCurrentState('은하 사진'))}>우리 은하 상상도</button>
                            </div>
                    </div>,
        '은하 사진': <div style={{paddingLeft:"15%", paddingTop:"3%"}}>
                        <img className="galaxyImage" alt="https://namu.wiki/w/%EC%9A%B0%EB%A6%AC%20%EC%9D%80%ED%95%98" src={우리은하} />
                        <AiOutlineArrowLeft style={{paddingLeft:"3%", fontSize:"100px"}} onClick={()=>(
                            setCurrentState('우리 은하'))}/>
                    </div>
    };
