...
const Camera = () => {
    ...
    const data = {
        '설정': <div style={{overflowY:"scroll", height:"580px", width:"105%"}} >
                    ...
                    <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                        ...
                        다만 셔터 속도가 1초보다 어두우면 별 사진이 거의 안나온다고 보면 되고, 너무 길어지면 렌즈의 화각에 따라 다르겠지만, 별이 점으로 나오는 것이 아니라 지구의 자전에 의해서 별이 1자 모양으로 흐르게 촬영한다.<br /><br />
                        예를 들어, 24mm 화각으로 촬영할 경우 보통 15초를 안 넘겨 촬영을 한다. 
                    </div>
                    ...
                    <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                        ...
                        따라서 튼튼한 삼각대가 있으면 좋다. 최대한 잘 고정해서 몇 초 내지는 수심 초가 되는 시간 동안 카메라가 조금이라도 흔들이지 않도록 해주면 된다.
                    </div>
                    <h2 style={{fontWeight:"700", fontSize:"20px", paddingTop:"2%"}}>조리개 값</h2>
                    <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                    조리개 값 즉 F값이 낮을수록 빛을 모으는 조리개가 더 크게 개방되고 따라서 더 많은 빛이 렌즈로 유입된다.<br /> 따라서 같은 셔터스피드로 별사진을 찍는다고 가정했을 때, 조리개 값을 더 낮게 설정해야 더 많은 별을 더 밝게
                    찍을 수 있다. <br /><br />보통 렌즈 최대 밝기에서 1~3단계 정도 조리개를 조여서 촬영한다.<br /> 만약 F1.4값을 가진 렌즈로 촬영한다면 조리개 값을 F1.4보다는 F1.8이나 F2.2, F2.8정도로 설정한다.<br /> 
                    바로 위에서 설명한 셔터 스피드를 충분히 길게 해준다면 조리개 값이 높아도(어두워도) 좋은 사진을 찍을 수 있다.
                    </div>
                    <h2 style={{fontWeight:"700", fontSize:"20px", paddingTop:"2%"}}>ISO</h2>
                    <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                        셔터 스피드와 조리개 값과 함께 사진의 노출 및 밝기에 관여하는 또 하나의 요소가 있는데 바로 ISO이다.<br /> ISO값은 높이면 높일수록 더 밝은 사진을 찍을 수 있다.
                        다만 수치가 높아질수록 사진에 노이즈가 많이 생기게 된다. 그래서 양날의 검이라 할 수 있다. <br /><br />  ISO는 조리개값이나 셔터 스피드를 더 이상 조정하기 곤란할떄 많이 사용한다.
                        조정이 불가할때 셔터 스피드를 다시 별이 흐르지 않는 시간까지 내려주고, ISO값을 올려주면 된다.<br /> 
                    ...
                    <div style={{fontWeight:"500", fontSize:"15px", lineHeight:"23px"}}>
                        ...
                        또한 지상에 있지만 최대한 멀리 있는 가로등이나 불빛을 대상으로 초점을 맞출 수도 있다. 앞에서 큰 별을 보고 초점을 맞춘것과 동일하게 지상에 있는 불빛이 최대한 선명하게 나올때까지 초점을 조절해 준다.
                    </div>
                </div>,
                '갤럭시': <div style={{overflowY:"scroll", height:"580px", width:"105%"}} >
                ...
                '아이폰': <div style={{overflowY:"scroll", height:"580px", width:"105%"}} >
            ...
            <div className="starBox">
                <div className="starBoxTop">
                    <div className="starBoxTop1" style={{textAlign:"left", paddingLeft:"10%", fontWeight:"bold",
                        fontSize:"40px", paddingTop:"6%"}}>촬영 Tip</div>
