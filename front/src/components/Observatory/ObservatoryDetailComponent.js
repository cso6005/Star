    ...
    <div>
      ...
      <div className="detailCard">
        ...
        <div className="detailCard2">
          ...
          <div
            class="info"
            dangerouslySetInnerHTML={{ __html: purify.sanitize(siteInfo) }}
            style={{ fontSize: "16px", color: "white", fontWeight: "bold", paddingTop: "0%", paddingLeft: "4%", paddingRight: "4%", textAlign: "center" }}
          />

          <div style={{ fontSize: "10px", color: "white", fontWeight: "bold", textAlign: "left", lineHeight: "120%" }}></div>
        </div>
      </div>
